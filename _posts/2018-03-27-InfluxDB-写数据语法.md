...
date: 2018-03-27 03:55:17 +0000
categories: ["监控告警"]
tags: []
description: "本篇是官方文档的一个蹩脚翻译，原文： Write Syntax 语法总是容易忘记，这里是一个参考手册 Table of Contents 行协议 ( Line Protocol ) 空格 Timestamp （时间戳） 键值（key-value）分隔符 转义字符 注释 数据类型 例子 最简单的合法写入点 (measur"
