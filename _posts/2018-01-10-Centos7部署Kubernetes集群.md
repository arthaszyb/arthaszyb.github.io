...
date: 2018-01-10 01:38:35 +0000
categories: ["docker"]
tags: ["Pages"]
description: "2018 年 1 月 10 日 9:38 Centos7 部署 Kubernetes 集群 1 、环境介绍及准备： 1.1 物理机操作系统 物理机操作系统采用 Centos7.3 64 位，细节如下。 [root@localhost ~]# uname -a Linux localhost.localdomain 3."
...
Node1
上执行：
[root@localhost ~]# hostnamectl --static set-hostname
...
FLANNEL_ETCD_PREFIX
是相对应的，错误的话启动就会出错）
[root@k8s-master ~]# etcdctl mk /atomic.io
etwork/config '{ "Network": "10.0.0.0/16" }'
