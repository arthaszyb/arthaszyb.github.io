...
date: 2017-11-24 02:05:04 +0000
categories: ["docker"]
tags: ["Pages"]
description: "2017 年 11 月 24 日 10:05 标签： 迁移 存储 docker 2016-05-06 11:36 25993 人阅读 评论 (1) 收藏 举报 分类： Docker（8） 版权声明：本文为博主皮皮http://blog.csdn.net/pipisorry原创文章，未经博主允许不得转载。 目录 (?)["
...
(?)[+]
http://
blog.csdn.net/pipisorry/article/details/51330126
Docker目录分析
...
mkdir -p $DOCKER_DIR
3 使用rsync工具同步
rsync -aXS /var/lib/docker/. $DOCKER_DIR
