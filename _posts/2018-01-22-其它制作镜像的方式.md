---
title: "其它制作镜像的方式"
date: 2018-01-22 03:00:53 +0000
categories: ["docker"]
tags: ["Pages"]
description: "2018 年 1 月 22 日 11:00 除了标准的使用 Dockerfile 生成镜像的方法外，由于各种特殊需求和历史原因，还提供了一些其它方法用以生成镜像。 从 rootfs 压缩包导入 格式： docker import [ 选项 ] < 文件 >| < URL>|- [ < 仓库名 >[: < 标签 >]] "
