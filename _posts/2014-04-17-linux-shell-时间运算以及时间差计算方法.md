...
date: 2014-04-17 10:05:16 +0000
categories: ["shell"]
tags: []
description: "最近一段时间，在处理Shell 脚本时候，遇到时间的处理问题。 时间的加减，以及时间差的计算。 1。 时间加减 这里处理方法，是将基础的时间转变为时间戳，然后，需要增加或者改变时间，变成 秒。 如：1990-01-01 01:01:01 加上 1小时 20分 处理方法： a.将基础时间转为时间戳 time1=$(dat"
