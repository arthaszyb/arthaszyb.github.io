...
date: 2018-03-20 09:18:01 +0000
categories: ["监控告警"]
tags: []
description: "2017年12月8日 范欣欣 时序数据库 在上篇文章 《时序数据库体系技术 – 时序数据存储模型设计》 中笔者分别介绍了多种时序数据库在存储模型设计上的一些考虑，其中OpenTSDB基于HBase对维度值进行了全局字典编码优化，Druid采用列式存储并实现了Bitmap索引以及局部字典编码优化，InfluxDB和Ber"
