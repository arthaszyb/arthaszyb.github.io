...
date: 2018-05-03 12:45:13 +0000
categories: ["监控告警"]
tags: []
description: "何处不可怜 关注 2016.05.14 11:30* 字数 2375 阅读 6471 评论 3 喜欢 33 赞赏 1 前言： 上手kafka已有2年的时间，我们的数据处理量也从最初的300g/day发展到今天的T量级在这个过程中也踩了不少坑，在这里分享出来和大家共勉。 一、硬件考量 1.1、内存 不建议为kafka分配"
