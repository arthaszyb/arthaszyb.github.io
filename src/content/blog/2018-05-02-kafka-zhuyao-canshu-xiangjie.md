...
lang: zh
origin_url: http://kafka.apache.org/documentation.html
---
...
# 当有新的consumer加入到group时,将尝试rebalance,将partitions的消费端迁移到新的consumer中, 该设置是尝试的次数
...
其他参考：http://www.inter12.org/archives/842
