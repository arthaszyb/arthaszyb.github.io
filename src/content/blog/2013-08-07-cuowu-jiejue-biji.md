...
date: '2013-08-07'
description: >-
  安装mysql，在./configure时出现错误：error: No curses/termcap library found的解决办法 作者：zccst
  mysql版本：5.1.30 已经不记得这次是第几次安装mysql了，遇到这个问题倒是第一次。
category: database
tags:
  - mysql
draft: false
...
```
待安装completed！之后，再./configure，顺利通过，然后make
&
&
make install，成功安装，一切OK！~~~
遇到无密码或者忘掉密码以及user表为空导致本地无法登陆的情况，请这样解决：
1.mysql stop
