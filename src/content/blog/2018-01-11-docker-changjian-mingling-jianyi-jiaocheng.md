...
date: '2018-01-11'
description: >-
  2018 年 1 月 11 日 20:21 Docker常见命令---简易教程 时间：2016-04-27 容器相关操作 获取容器相关信息 导出容器 执行
  docker exec # 在容器里执行一个命令，可以执行bash进入交互式 镜像操作 镜像仓库(registry)操作 获取Container
...
docker tag csphere
ginx:1.7 192.168.1.2/csphere
ginx:1.7
docker push 192.168.1.2/csphere
ginx:1.7
几个简单小例子
容器操作
创建并拉取busybox
...
来自
<
http://www.youruncloud.com/docker/1_37.html
>
