---
title: 'linux中系统性能分析命令top用法详解,总结'
date: '2014-06-27'
description: >-
  top命令是Linux系统下常用的性能分析工具，它能够实时的显示系统中各个进程的资源占用状况，知道哪些进程占用多少系统资源,类似于Windows下的任务管理器。 
  下面详细介绍它的使用方法。
category: linux
tags:
  - 监控告警
...
Z=僵尸进程 x COMMAND 命令名/命令行

y WCHAN 若该进程在睡眠，则显示睡眠中的系统函数名 z Flags 任务标志，参考 sched.h
...
1、 f 键可以选择显示的内容。按 f 键之后会显示列的列表，按 a-z 即可显示或隐藏对应的列，最后按回车键确定
