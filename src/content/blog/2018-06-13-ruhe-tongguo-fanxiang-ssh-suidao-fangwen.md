...
![](/images/legacy/legacy-9dfe00d7ac.jpg)
...
1. homeserver~$ ssh \-fN \-R 10022:localhost:22 relayserver\_user@1.1.1.1
...
1. relayserver~$ ssh \-p 10022 homeserver\_user@localhost
...
1. relayserver~$ vi /etc/ssh/sshd\_config
...
1. homeserver~$ ssh \-fN \-R 1.1.1.1:10022:localhost:22 relayserver\_user@1.1.1.1
...
1. clientcomputer~$ ssh \-p 10022 homeserver\_user@1.1.1.1
...
1. homeserver~$ autossh \-M 10900 \-fN \-o "PubkeyAuthentication=yes" \-o "StrictHostKeyChecking=false" \-o "PasswordAuthentication=no" \-o "ServerAliveInterval 60" \-o "ServerAliveCountMax 3" \-R 1.1.1.1:10022:localhost:22 relayserver\_user@1.1.1.1
