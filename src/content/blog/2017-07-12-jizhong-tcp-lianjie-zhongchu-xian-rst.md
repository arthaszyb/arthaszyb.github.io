...
lang: zh
origin_url: https://my.oschina.net/costaxu/blog/127394
---
在 TCP 协议中，RST 表示复位，用来异常关闭连接。发送 RST 包时无需等待缓冲区清空，直接丢弃缓存并发送重置信号；接收端收到 RST 后也无需发送 ACK 确认。
