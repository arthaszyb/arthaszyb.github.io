...
date: '2018-01-31'
description: >-
  By Liushy Apr 29 2017 Updated:Apr 30 2017 前言
  结合自己最近的学习和实践，总结了一下libvirt和qemu-kvm的理解和使用，其中包括工具链的安装以及部分操作命令。  QEMU简单入门
  qemu是什么，简单来说它是一个虚拟机的管理器，类似Virtualbox之类的。
