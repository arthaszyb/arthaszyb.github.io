...
date: '2014-11-14'
description: >-
  博客分类： Apache 一、modfcgid概念说明以及modfastcgi和modfcgid的区别
  modfcgid是一个跟modfastcgi二进制兼容的Apache module。 
  原来的modfastcgi因为实现方式的限制，所以可能会创建了很多不必要的进程，而实际上只需要更少的进程就能处理同样的请求。
category: web-infra
tags:
  - apache
  - php
