---
title: "mysql如何使用load\_data\_infile导入中文数据"
date: '2017-09-15'
description: >-
  2017 年 9 月 15 日 17:30 mysql如何使用load data infile导入中文数据 (2015-08-05 17:21:40) 转载
  ▼ 标签： 佛学 分类： MySQL mysql 导入数据时，可以使用 load data infile ，导入数据很快，当需要导入大量数据的时候及其有效。
category: database
tags:
  - mysql
  - php
