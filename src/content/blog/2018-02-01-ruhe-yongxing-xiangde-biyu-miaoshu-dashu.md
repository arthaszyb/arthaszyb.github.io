---
title: 大数据生态技术体系概览：Hadoop、Hive、Spark 的关系与对标
date: '2018-02-01'
description: 大数据技术生态的全景解读。从存储（HDFS）、计算（MapReduce/Spark/Tez）、查询（Hive/Impala）、学习（Mahout）多角度讲解技术栈及演进路线。
category: bigdata
tags:
  - apache
  - hadoop
...
lang: zh
origin_url: https://www.zhihu.com/question/27974418
---
## 大数据生态体系
